...
const file_common_conf_logger_proto_rawDesc = "" +
	"\n" +
	"\x18common/conf/logger.proto\x12\vcommon.conf\"\x99\a\n" +
	"\x06Logger\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12)\n" +
	"\x03zap\x18\x02 \x01(\v2\x17.common.conf.Logger.ZapR\x03zap\x122\n" +
	"\x06logrus\x18\x03 \x01(\v2\x1a.common.conf.Logger.LogrusR\x06logrus\x122\n" +
	"\x06fluent\x18\x04 \x01(\v2\x1a.common.conf.Logger.FluentR\x06fluent\x122\n" +
	"\x06aliyun\x18\x05 \x01(\v2\x1a.common.conf.Logger.AliyunR\x06aliyun\x125\n" +
	"\atencent\x18\x06 \x01(\v2\x1b.common.conf.Logger.TencentR\atencent\x1a\x8c\x01\n" +
	"\x03Zap\x12\x1a\n" +
	...
	"\n" +
	"access_key\x18\x03 \x01(\tR\taccessKey\x12#\n" +
	"\raccess_secret\x18\x04 \x01(\tR\faccessSecretB\x97\x01\n" +
	"\x0fcom.common.confB\vLoggerProtoP\x01Z*kratos-gorm-example/api/gen/go/common/conf\xa2\x02\x03CCX\xaa\x02\vCommon.Conf\xca\x02\vCommon\\Conf\xe2\x02\x17Common\\Conf\\GPBMetadata\xea\x02\fCommon::Confb\x06proto3"
